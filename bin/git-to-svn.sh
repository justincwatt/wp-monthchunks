...
# main config
PLUGINSLUG="monthchunks"
MAINFILE="monthchunks.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/monthchunks/" # Remote SVN repo on wordpress.org, with no trailing slash
